...
int main(int argc, char* argv[])
{
  ...
  ///////////////////////// TODO change here
  std::string outfilename = "../../../../../Dropbox/Software/MatLab_Files/Oxford/C++ Supplements/results/" + filenamearg + "_gmres1.txt";
  ...
  {
    flag = argv[2];
    outfilename = "../../../../../Dropbox/Software/MatLab_Files/Oxford/C++ Supplements/results/" + filenamearg + flag +"_gmres1.txt";
  }
  ...
  Matrix x = GMRES(M,b,x0,1e-10,outfile);
